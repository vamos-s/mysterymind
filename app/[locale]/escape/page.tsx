      ...
      >
        ...
        <div className="mb-6 p-4 bg-white/10 dark:bg-black/20 backdrop-blur-sm rounded-xl">
          <h3 className="text-lg font-semibold text-white mb-3">
            {t('games.escape.inventory')}
          </h3>
          <div className="flex gap-2 flex-wrap">
            {inventory.length === 0 ? (
              <p className="text-white/60 text-sm">{t('games.escape.empty')}</p>
            ) : (
        ...
        <div className="relative bg-gray-200 dark:bg-gray-700 rounded-xl aspect-[4/3] mb-6 overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center text-gray-400">
            <div className="text-center">
              ...
              <p className="text-lg">{t('games.escape.room')}</p>
              <p className="text-sm">{t('games.escape.clickHint')}</p>
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  placeholder={t('games.escape.enterSolution')}
          ...
          {showHint && (
            ...
            >
              <h4 className="font-bold text-yellow-800 dark:text-yellow-300 mb-2">
                💡 {t('games.escape.hint', { used: hintsUsed, total: currentProblem.hintCount })}
              </h4>
          ...
          {gameComplete && (
            ...
            >
              <h3 className="text-3xl font-bold text-green-600 dark:text-green-400 mb-4">
                {t('games.escape.complete')} 🎉
              </h3>
              <p className="text-gray-700 dark:text-gray-300">
                {t('games.escape.escaped')}
              </p>
            </motion.div>
          )}
        </AnimatePresence>
