          ...
          <div className="mb-6 p-4 bg-white/10 dark:bg-black/20 backdrop-blur-sm rounded-xl">
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-4 text-white/80">
                <span>✅ Found: {foundDifferences.size}/{currentProblem.totalDifferences}</span>
                <span>⏳ Remaining: {remainingDifferences}</span>
              </div>
            </div>
          </div>
            ...
            {gameComplete && (
              ...
              >
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  You found all {currentProblem.totalDifferences} differences!
                </p>
              </motion.div>
            )}
          </AnimatePresence>
