          ...
          <div className="mb-6 p-4 bg-white/10 dark:bg-black/20 backdrop-blur-sm rounded-xl">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex gap-4 text-white/80">
                <span>✅ Found: {foundObjects.size}</span>
                <span>⏳ Remaining: {remainingObjects}</span>
              </div>
            </div>
          ...
          <div className="relative bg-gray-200 dark:bg-gray-700 rounded-xl aspect-[4/3] mb-6 overflow-hidden">
            <div className="absolute inset-0 flex items-center justify-center text-gray-400">
              <div className="text-center">
                ...
                <p className="text-lg">Game Scene</p>
                <p className="text-sm">Click on objects to find them</p>
              </div>
            </div>
            ...
            {gameComplete && (
              ...
              >
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  You found all {currentProblem.objects.length} objects!
                </p>
              </motion.div>
            )}
          </AnimatePresence>
